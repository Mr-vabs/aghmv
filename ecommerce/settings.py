...
EMAIL_HOST = 'smtp-relay.brevo.com'  # SMTP Server from Brevo
EMAIL_PORT = 587  # Port from Brevo
EMAIL_HOST_USER = '86cd8f001@smtp-brevo.com'  # Replace with your actual Brevo SMTP login
EMAIL_HOST_PASSWORD = 'hjbZVvGP8TDdUxAC'  # Use the SMTP key for Django_proj or Master Password
EMAIL_USE_TLS = True  # Required for Brevo
EMAIL_USE_SSL = False  # Ensure this is False as TLS is being used
DEFAULT_FROM_EMAIL = 'no-reply@example.com'  # Ensures sender email is correct
